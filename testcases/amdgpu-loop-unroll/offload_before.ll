; ModuleID = '/tmp/bench_offload-cecf34.bc'
...
define dso_local range(i32 0, 2) i32 @main() local_unnamed_addr #0 {
  ...
  br i1 %.not, label %26, label %vector.body

vector.body:                                      ; preds = %0, %vector.body
  %index = phi i64 [ %index.next, %vector.body ], [ 0, %0 ]
  %vec.ind = phi <4 x i32> [ %vec.ind.next, %vector.body ], [ <i32 0, i32 1, i32 2, i32 3>, %0 ]
  %5 = uitofp nneg <4 x i32> %vec.ind to <4 x float>
  %6 = getelementptr inbounds nuw [4 x i8], ptr %4, i64 %index
  store <4 x float> %5, ptr %6, align 4, !tbaa !13
  %index.next = add nuw i64 %index, 4
  %vec.ind.next = add <4 x i32> %vec.ind, splat (i32 4)
  %7 = icmp eq i64 %index.next, 1048576
  br i1 %7, label %.preheader, label %vector.body, !llvm.loop !15
...
21:                                               ; preds = %.preheader, %24
  %.01722 = phi i32 [ 0, %.preheader ], [ %25, %24 ]
  ...
  store i64 1048576, ptr %18, align 8
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(36) %19, i8 0, i64 36, i1 false)
  %22 = call i32 @__tgt_target_kernel(ptr nonnull @3, i64 -1, i32 0, i32 0, ptr nonnull @.__omp_offloading_811_507524_main_l15.region_id, ptr nonnull %3)
...
24:                                               ; preds = %21, %23
  %25 = add nuw nsw i32 %.01722, 1
  %exitcond24.not = icmp eq i32 %25, 20
  br i1 %exitcond24.not, label %20, label %21, !llvm.loop !20
...
13:                                               ; preds = %.lr.ph, %13
  ...
  %15 = load i32, ptr %5, align 4, !llvm.access.group !21
  %16 = zext i32 %15 to i64
  %17 = zext i32 %14 to i64
  call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr nonnull @3, i32 4, ptr nonnull @__omp_offloading_811_507524_main_l15.omp_outlined.omp_outlined, i64 %16, i64 %17, i64 %.sroa.0.0.insert.ext, ptr %3), !llvm.access.group !21
  %18 = load i32, ptr %7, align 4, !tbaa !8, !llvm.access.group !21
  %19 = add nsw i32 %18, %.08
  %20 = load i32, ptr %6, align 4, !tbaa !8, !llvm.access.group !21
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x float>, ptr %gep, align 4, !tbaa !13, !llvm.access.group !25
  %23 = fmul <4 x float> %wide.load, splat (float 2.000000e+00)
  store <4 x float> %23, ptr %gep, align 4, !tbaa !13, !llvm.access.group !25
  %index.next = add nuw i64 %index, 4
  %24 = icmp eq i64 %index.next, %n.vec
  br i1 %24, label %middle.block, label %vector.body, !llvm.loop !26
...
.lr.ph:                                           ; preds = %.lr.ph.preheader14, %.lr.ph
  %indvars.iv = phi i64 [ %indvars.iv.next, %.lr.ph ], [ %indvars.iv.ph, %.lr.ph.preheader14 ]
  %25 = getelementptr inbounds [4 x i8], ptr %5, i64 %indvars.iv
  %26 = load float, ptr %25, align 4, !tbaa !13, !llvm.access.group !25
  %27 = fmul float %26, 2.000000e+00
  store float %27, ptr %25, align 4, !tbaa !13, !llvm.access.group !25
...
; Function Attrs: nounwind
declare !callback !29 void @__kmpc_fork_call(ptr, i32, ptr, ...) local_unnamed_addr #4

; Function Attrs: nounwind
declare !callback !29 void @__kmpc_fork_teams(ptr, i32, ptr, ...) local_unnamed_addr #4
...
!25 = distinct !{}
!26 = distinct !{!26, !27, !18, !19}
!27 = !{!"llvm.loop.parallel_accesses", !25}
!28 = distinct !{!28, !27, !19, !18}
!29 = !{!30}
